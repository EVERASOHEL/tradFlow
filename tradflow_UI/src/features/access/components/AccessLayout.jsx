...
export default function AccessLayout() {
  ...
  const userRole = Array.isArray(user?.roles)
    ? (user.roles[0]?.name || user.roles[0]?.code || user.roles[0] || "Admin")
    : "Administrator";
  ...
  return (
    <div className="access-shell">
      ...
      <aside className="access-sidebar">
        <Link className="access-brand" to={ROUTES.SETTINGS_OVERVIEW}>
      ...
      <div className="access-workspace">
        <header className="access-topbar">
          <div className="access-breadcrumb">
            <span className="crumb-segment">Settings</span>
            <span className="crumb-separator">/</span>
            <strong className="crumb-active">User &amp; Access Management</strong>
          </div>
